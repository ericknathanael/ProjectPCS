...
INSERT INTO KARYAWAN VALUES(1,1,'PATKUS123','PatricKus','PATRICK KUSANAGI',4,TO_DATE('12/03/2018','DD/MM/YYYY'));
INSERT INTO KARYAWAN VALUES(2,3,'ANDREHEBAT','AndrianSug','ANDRIAN SUGIANTO',2,TO_DATE('12/03/2018','DD/MM/YYYY'));
INSERT INTO KARYAWAN VALUES(3,4,'LUKKY23','LukkyHar','LUKKY HARIYANTO',2,TO_DATE('24/12/2020','DD/MM/YYYY'));
INSERT INTO KARYAWAN VALUES(4,2,'STEVEN57','StevenLim','STEVEN LIEM',1,TO_DATE('24/01/2021','DD/MM/YYYY'));

INSERT INTO ABSENSI VALUES(1,1,TO_TIMESTAMP('10:24:30','HH24:MI:SS'),TO_TIMESTAMP('22:24:30','HH24:MI:SS'),TO_TIMESTAMP('12/12/2000','DD/MM/YYYY'));
INSERT INTO ABSENSI VALUES(2,2,TO_TIMESTAMP('09:11:14','HH24:MI:SS'),TO_TIMESTAMP('22:11:12','HH24:MI:SS'),TO_TIMESTAMP('12/12/2000','DD/MM/YYYY'));
INSERT INTO ABSENSI VALUES(3,3,TO_TIMESTAMP('10:03:24','HH24:MI:SS'),TO_TIMESTAMP('22:07:01','HH24:MI:SS'),TO_TIMESTAMP('12/12/2000','DD/MM/YYYY'));
INSERT INTO ABSENSI VALUES(4,4,TO_TIMESTAMP('10:01:01','HH24:MI:SS'),TO_TIMESTAMP('22:10:19','HH24:MI:SS'),TO_TIMESTAMP('12/12/2000','DD/MM/YYYY'));
INSERT INTO ABSENSI VALUES(5,1,TO_TIMESTAMP('10:08:30','HH24:MI:SS'),TO_TIMESTAMP('22:02:56','HH24:MI:SS'),TO_TIMESTAMP('13/12/2000','DD/MM/YYYY'));
