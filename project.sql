...
CREATE TABLE MEJA(
	ID NUMBER PRIMARY KEY,
	TERSEDIA VARCHAR2(1) NOT NULL CHECK(TERSEDIA = 'N' OR TERSEDIA = 'Y')
);
...
CREATE TABLE D_TRANSAKSI(
	NOMOR_NOTA NUMBER REFERENCES TRANSAKSI(NOMOR_NOTA),
	ID_PELANGGAN NUMBER REFERENCES PELANGGAN(ID),
...
INSERT INTO MENU VALUES(1,1,'CG001','CUMI GORENG TEPUNG',1,35000,0);
INSERT INTO MENU VALUES(2,1,'CG002','CUMI GORENG MENTEGA',0,20000,25);
INSERT INTO MENU VALUES(3,2,'AB001','AYAM BAKAR',1,35000,10);
INSERT INTO MENU VALUES(4,3,'CB001','CAH BABY KAILAN',0,37000,20);
INSERT INTO MENU VALUES(5,3,'CK001','CAH KANGKUNG',1,21000,0);
...
INSERT INTO JABATAN VALUES(2,'KOKI',10000000);
INSERT INTO JABATAN VALUES(3,'PELAYAN',4000000);
INSERT INTO JABATAN VALUES(4,'KASIR',3500000);
INSERT INTO JABATAN VALUES(5,'RESEPSIONIS',3000000);
